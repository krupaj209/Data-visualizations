        ...
        entrances: [
          {
            ...
            note: "Default queue at the official ticket office. Long lines from 9am to noon.",
          },
          {
            ...
            note: "Used by pre-booked timed-entry holders. Arrive 10 min before your slot.",
          },
          {
            ...
            note: "Group-only gate; individuals not admitted here.",
          },
          {
            name: "Step-free entrance",
            status: "accessible",
            best_for: ["wheelchair users", "strollers"],
            note: "Ramp and lift access; ring the bell at Sant'Anna for assistance.",
          },
          {
            name: "Old service gate",
            status: "closed",
            note: "Staff-only; do not queue here despite older guidebook maps.",
          },
        ],
        callout:
          "Pre-book a timed slot and use Sant'Anna — it's the single biggest time-saver at the Vatican Museums.",
      },
    },
    {
