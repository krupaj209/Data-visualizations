// Hand-curated chart deck for the Galleria degli Uffizi. Mirrors the
// `seasonal_curve` structure used for the Accademia so the Florence cluster
// shows the upgraded Crowds / Weather / Price chart consistently.
